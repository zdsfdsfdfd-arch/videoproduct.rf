...
export function TeamPage() {
  return (
    <PageShell index="04" kicker="15 СПЕЦИАЛИСТОВ · 8 В КАДРЕ · КАЗАНЬ" title={<>Коман<em>да</em></>} lead="Сценаристы, операторы, монтажёры, звук, свет, грим — 15 специалистов и своё оборудование на 5 000 000 ₽. Наведите на человека на сцене — увидите его ремесло.">
      <Team />
