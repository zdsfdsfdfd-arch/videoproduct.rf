...
export function Effects({ i, person, box, stage }: { i: number; person: Person; box: Box; stage: HTMLDivElement }) {
  ...
  return (
    <>
      ...
      {/* the per-craft scene plays on phones too (a tap starts it); the parts that are drawn around a
          desktop-size figure and would hang off a phone screen are dropped in TeamFx.module.css */}
